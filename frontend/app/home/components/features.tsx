      ...
      <div className="grid lg:grid-cols-3 gap-4">
        <div className="border relative rounded-md p-6 shadow-sm space-y-3">
          ...
          <h2 className="font-bold">
            NFT Minting of ERC721 <Link href="/mint" className="absolute inset-0" />
          </h2>
          <p>NFTをミントできます</p>
        </div>
        ...
        <div className="border relative rounded-md p-6 shadow-sm space-y-3">
          <div className="aspect-video bg-muted flex items-center justify-center">
            <Image
              src="/image/gasless-mint-banner.png"
              alt="Gasless NFT Minting of ERC721"
              width={640}
              height={360}
            />
          </div>
          <h2 className="font-bold">
            ...
            <Link href="/gasless-mint" className="absolute inset-0" />
          </h2>
